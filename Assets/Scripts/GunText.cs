...
public class GunText : MonoBehaviour {
    ...
    public ProjectileLauncher m_Gun;

    public TextType m_TextType;

    public enum TextType { Velocity, Range, CorrectGunAngleLow, CorrectGunAngleHigh };
	...
	void Update () {
        ...
        switch (m_TextType)
        {
            ...
            case TextType.CorrectGunAngleLow:
                result = ReplaceFirst(result, c_EscapeCharacter, m_Gun.m_CorrectGunAngleLow.ToString(m_SpecifiedStringFormat));
                break;

            case TextType.CorrectGunAngleHigh:
                result = ReplaceFirst(result, c_EscapeCharacter, m_Gun.m_CorrectGunAngleHigh.ToString(m_SpecifiedStringFormat));
                break;

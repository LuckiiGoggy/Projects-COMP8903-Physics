...
/// a pre-set angle.
/// </summary>
public class ProjectileLauncher : PhysicsObject {
	...
	void FixedUpdate () {
        ...
        m_CorrectGunAngleHigh = 90 - (Mathf.Asin((9.81f * m_Range) / (m_ProjectileInitialVelocityMagnitude * m_ProjectileInitialVelocityMagnitude)) / 2 * Mathf.Rad2Deg);
    }
